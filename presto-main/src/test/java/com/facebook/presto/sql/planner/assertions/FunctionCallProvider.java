    ...
    implements ExpectedValueProvider<FunctionCall>
{
    ...
    private FunctionCallProvider(boolean isWindowFunction, QualifiedName name, Optional<WindowFrame> frame, boolean distinct, List<SymbolAlias> args)
    {
    ...
    FunctionCallProvider(QualifiedName name, Optional<WindowFrame> frame, boolean distinct, List<SymbolAlias> args)
    {
    ...
    private class ExpectedWindowFunctionCall extends FunctionCall
    {
        ...
        public int hashCode()
        {
            // Test object. Don't put it in a hash table.
